...
public class OsgiIT {
    ...
    public Option[] config() throws IOException {
        ...
        PathMatcher matcher =
                fs.getPathMatcher("glob:org.apache.sling.connection-timeout-agent-*-jar-with-dependencies.jar");
        ...
        return options(
                ...
                vmOption("-javaagent:" + agentCandidates.get(0)
                        + "=10000,1,v") // large connect timeout, very small read timeout
                );
    }
